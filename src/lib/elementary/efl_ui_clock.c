...
EOLIAN static void
_efl_ui_clock_evas_object_smart_del(Eo *obj, Efl_Ui_Clock_Data *sd)
{
   Clock_Field *tmp;
   unsigned int idx;
...
_efl_ui_clock_field_limit_set(Eo *obj, Efl_Ui_Clock_Data *sd, Efl_Ui_Clock_Type fieldtype, int min, int max)
{
   ...
   if (!_field_cmp(fieldtype, &old_time, &sd->curr_time))
     eo_event_callback_call(obj, EFL_UI_CLOCK_EVENT_CHANGED, NULL);

}

EOLIAN static Eina_Bool
_efl_ui_clock_value_get(const Eo *obj EINA_UNUSED, Efl_Ui_Clock_Data *sd, struct tm *currtime)
{
...
EOLIAN static Eina_Bool
_efl_ui_clock_value_set(Eo *obj, Efl_Ui_Clock_Data *sd, const struct tm *newtime)
{
...
EOLIAN static Eina_Bool
_efl_ui_clock_value_min_get(const Eo *obj EINA_UNUSED, Efl_Ui_Clock_Data *sd, struct tm *mintime)
{
...
EOLIAN static Eina_Bool
_efl_ui_clock_value_min_set(Eo *obj, Efl_Ui_Clock_Data *sd, const struct tm *mintime)
{
   struct tm old_time;
...
EOLIAN static Eina_Bool
_efl_ui_clock_value_max_get(const Eo *obj EINA_UNUSED, Efl_Ui_Clock_Data *sd, struct tm *maxtime)
{
...
EOLIAN static Eina_Bool
_efl_ui_clock_value_max_set(Eo *obj, Efl_Ui_Clock_Data *sd, const struct tm *maxtime)
{
   struct tm old_time;
...
EOLIAN static void
_efl_ui_clock_class_constructor(Eo_Class *klass)
{
